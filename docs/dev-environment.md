...
GX10_BASE_URL=http://host.docker.internal:8000/v1 GX10_MODEL=your-model \
...
Then drive it with the thin client from your host (so your code stays on your machine):
