...
| **Docs & process** (doc-reality-audit + roadmap generator + process-doctor invariants + export-sync, negative tests) | `doc_audit`, `gen_roadmap`, `process_doctor`, `export_sync_check`, `export_secret_gate`, `release_preflight` | 52 |
