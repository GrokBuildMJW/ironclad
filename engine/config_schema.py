...
_SPECS = [
    ...
    _leaf("code_review.mode", str, "off", enum=("off", "simple", "review_of_review"),
          classification=SWITCH, env_names=("GX10_CODE_REVIEW_MODE",)),
    _leaf("code_review.max_rounds", int, 2, minimum=1, maximum=10,
          env_names=("GX10_CODE_REVIEW_MAX_ROUNDS",)),
    _leaf("code_review.agent", str, "", env_names=("GX10_CODE_REVIEW_AGENT",)),
