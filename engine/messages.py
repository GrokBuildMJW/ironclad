...
directive). This catalog localizes the engine's OWN user-facing chrome — command responses,
error texts, and the prose written into the self-maintaining vault (INDEX/related headings).

- Keys are stable, English, dotted (e.g. ``init.no_active``). Call sites use ``msg("init.no_active")``.
...
_MESSAGES: dict[str, dict[str, str]] = {
    "en": {
        ...
        "project.cmd_unit_active": "[project] active unit: {slug} (type {type}) -> {path}/",
        ...
        "config.unknown_key_suggestion": " Did you mean '{candidate}'?",
        "config.unknown_key_candidates": " Matching keys (choose one): {candidates}{more}.",
        "config.unknown_key_more": " (+{n} more)",
    ...
    "de": {
        ...
        "init.cmd_active": "[initiative] active: {slug} (type {type}) -> {path}/",
        "project.cmd_unit_active": "[project] aktive Einheit: {slug} (Typ {type}) -> {path}/",
        ...
        "config.unknown_key_suggestion": " Meinten Sie '{candidate}'?",
        "config.unknown_key_candidates": " Passende Keys (einen auswählen): {candidates}{more}.",
        "config.unknown_key_more": " (+{n} weitere)",
